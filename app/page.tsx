              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-lg text-gray-700 mb-6">
                    Pomoc w zgłoszeniu wypadku przy pracy. Asystent pomoże Ci wypełnić wszystkie wymagane pola, 
                    wskaże brakujące elementy i zasugeruje uzupełnienia zgodnie z wymogami ZUS.
                  </p>
                  <div className="grid md:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Przyjazny interfejs</h3>
                        <p className="text-sm text-gray-600">Intuicyjny formularz krok po kroku</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Wskazanie brakujących elementów</h3>
                        <p className="text-sm text-gray-600">Automatyczna weryfikacja kompletności</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Sugestie uzupełnień</h3>
                        <p className="text-sm text-gray-600">Inteligentne podpowiedzi i przykłady</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-green-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Zgodność z przepisami</h3>
                        <p className="text-sm text-gray-600">Zgodność z wymogami ZUS</p>
                      </div>
                    </div>
                  </div>
                  <Link
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              Zawiadomienie o wypadku przy pracy należy złożyć w następujących sytuacjach:
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-xl p-6 border-2 border-red-100">
                ...
                <p className="text-gray-700">
                  Gdy doznałeś urazu podczas wykonywania zwykłych czynności związanych z prowadzoną działalnością gospodarczą.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-xl p-6 border-2 border-amber-100">
                ...
                <p className="text-gray-700">
                  Gdy wypadek nastąpił podczas podróży związanej z wykonywaniem działalności gospodarczej.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-100">
                ...
                <p className="text-gray-700">
                  Gdy wypadek nastąpił podczas wykonywania zadań związanych z działalnością poza miejscem jej prowadzenia.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-100">
                ...
                <p className="text-gray-700">
                  Gdy wypadek nastąpił podczas szkolenia związanego z wykonywaną działalnością gospodarczą.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-100">
                ...
                <p className="text-gray-700">
                  Gdy wypadek nastąpił podczas bezpośredniej obsługi klienta w ramach prowadzonej działalności.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border-2 border-indigo-100">
                ...
                <p className="text-gray-700">
                  Wszystkie inne sytuacje, gdy wypadek nastąpił w związku z wykonywaną działalnością gospodarczą.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
              Informacje o ubezpieczeniu wypadkowym i przepisach regulujących zgłoszenia wypadków przy pracy
            </p>

            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border-2 border-gray-200">
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Zakład Ubezpieczeń Społecznych (ZUS) jest instytucją, która przede wszystkim gromadzi składki na ubezpieczenia społeczne, 
                  przyznaje i wypłaca świadczenia. Ubezpieczenia społeczne obejmują ubezpieczenia:
                </p>
                ...
                <div className="bg-blue-50 border-l-4 border-blue-600 p-6 mb-8 rounded-r-lg">
                  <p className="text-gray-800 leading-relaxed">
                    <strong className="text-blue-900">Każde z tych ubezpieczeń chroni nas przed innym rodzajem ryzyka.</strong> Ubezpieczenie 
                    wypadkowe chroni przed ryzykiem wypadku przy pracy, o którym mowa w{" "}
                    <a
                    ...
                    >
                      ustawie z 30 października 2002 r. o ubezpieczeniu społecznym z tytułu wypadków przy pracy i chorób zawodowych
                    </a>
                    .
                  </p>
                </div>
                ...
                <p className="text-gray-700 leading-relaxed mb-8">
                  ...
                  <a
                    ...
                    className="text-blue-600 hover:text-blue-800 underline font-semibold"
                  >
                    rozporządzenia Ministra Rodziny i Polityki Społecznej z 23 stycznia 2022 r.
                  </a>{" "}
                  – obsługuje między innymi zawiadomienia o wypadku przy pracy, osób które prowadzą pozarolniczą działalność gospodarczą.
                </p>
                    ...
                    <ul className="space-y-3">
                      <li>
                        ...
                        >
                          ...
                          <span>Ustawa z 30 października 2002 r. o ubezpieczeniu społecznym z tytułu wypadków przy pracy i chorób zawodowych</span>
                        </a>
                      </li>
                      <li>
                        <a
                        ...
                        >
                          <span className="flex-shrink-0">📄</span>
                          <span>Rozporządzenie Ministra Rodziny i Polityki Społecznej z 23 stycznia 2022 r.</span>
                        </a>
                      </li>
                    </ul>
                  </div>
