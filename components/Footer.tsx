...
export default function Footer() {
  return (
    <footer className="bg-[#007834] text-white relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-green-50 leading-relaxed mb-4">
              ZANT (ZUS Accident Notification Tool) to system wspierający
              procesy ZUS w zakresie wypadków przy pracy dla osób prowadzących
              pozarolniczą działalność gospodarczą. Pomagamy w prawidłowym
              wypełnieniu dokumentów i zgłoszeniu wypadku zgodnie z wymogami
              prawnymi.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-green-50 mb-3 leading-relaxed">
              W sprawach dotyczących wypadków przy pracy skontaktuj się z
        ...
        <div className="border-t border-green-600 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-green-50">
            <p className="mb-2 md:mb-0">
              © 2025 ZANT - ZUS Accident Notification Tool
            </p>
